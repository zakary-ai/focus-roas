...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Connect your OpenAI Ads account, set up conversion tracking, and view ROAS in a single dashboard." },
      { property: "og:title", content: "ROAS.ai — Track & Optimize Your OpenAI Ads ROAS" },
      { property: "og:description", content: "Connect your OpenAI Ads account, set up conversion tracking, and view ROAS in a single dashboard." },
    ],
  }),
  component: Index,
});
    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-accent/30">
      ...
      <main className="mx-auto max-w-6xl px-6 pb-24 pt-16">
        ...
        <section className="mt-24 grid gap-6 md:grid-cols-3">
          {[
            { icon: BarChart3, title: "ROAS Dashboard", body: "Spend, revenue, clicks and ROAS across every campaign — in one view." },
            { icon: Link2, title: "UTM Generator", body: "Tag every product URL correctly so OpenAI Ads attributes revenue back to the right campaign." },
            { icon: Shield, title: "Conversion Setup", body: "A guided checklist to wire up the Purchase event with variable value tracking." },
          ].map((f) => (
