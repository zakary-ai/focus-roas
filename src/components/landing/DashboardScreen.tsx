...
const kpis: Kpi[] = [
  ...
  { k: "Conversions", v: "1,162", delta: "+26%", spark: "up" },
  { k: "Clicks", v: "77,228", delta: "+26%", spark: "up" },
  { k: "Conversion Rate", v: "1.50%", spark: "flat" },
  { k: "Cost / Result", v: "$41.34", spark: "down" },
  { k: "Active Campaigns", v: "4", spark: "flat" },
];

const nav: [string, string, boolean][] = [
  ["Growth Command Center", "M3 3h7v7H3zM14 3h7v4h-7zM14 10h7v11h-7zM3 13h7v8H3z", true],
  ["Campaign Strategy", "M12 21a9 9 0 100-18 9 9 0 000 18zM15 9l-2 5-4 1 2-5z", false],
  ["Campaigns", "M13 2L3 14h7l-1 8 10-12h-7z", false],
  ["Attribution", "M5 19l5-5 4 4 6-8M21 8V4h-4", false],
  ["Tracking Events", "M3 12h4l2-6 4 12 2-6h6", false],
  ["Connectors", "M9 15l6-6M11 6l1-1a4 4 0 016 6l-1 1M13 18l-1 1a4 4 0 01-6-6l1-1", false],
  ["Landing Pages", "M3 5h18v14H3zM3 9h18", false],
  ["Reports", "M4 20V10M10 20V4M16 20v-7M22 20h-20", false],
  [
    "Settings",
    "M12 15a3 3 0 100-6 3 3 0 000 6zM19 12a7 7 0 00-.1-1l2-1.6-2-3.4-2.4 1a7 7 0 00-1.7-1L14.5 2h-4l-.3 2.6a7 7 0 00-1.7 1l-2.4-1-2 3.4L4 11a7 7 0 000 2l-2 1.6 2 3.4 2.4-1a7 7 0 001.7 1l.3 2.6h4l.3-2.6a7 7 0 001.7-1l2.4 1 2-3.4-2-1.6a7 7 0 00.1-1z",
    false,
  ],
];
    ...
    <div className={`dash-screen${active ? " dash-in" : ""}`} aria-hidden>
      ...
      <aside className="dash-rail">
        ...
        <div className="dash-store">
          ...
          <span className="dash-store-nm">Demo Account</span>
        ...
        <div className="dash-rail-foot">
          ...
          <div className="dash-conn">
            ...
            <span className="dash-conn-ok">Active</span>
          </div>
        ...
        <header className="dash-topbar">
          ...
          <div className="dash-tb-right">
            <span className="dash-pill">
              <i className="dot" /> ChatGPT Ads
            </span>
            <span className="dash-pill">
              <i className="dot" /> Connectors
            </span>
        ...
        <div className="dash-scroll">
          ...
          <section className="dash-banner">
            <div className="dash-banner-main">
              <span className="dash-eyebrow">Demo Account · Last 30 days</span>
              <h1>Your ChatGPT Ads performance, tracking, and revenue in one place.</h1>
              <div className="dash-chips">
                <span className="chip ok">✓ ChatGPT Ads tracking live</span>
                <span className="chip ok">✓ Conversion sources connected</span>
                <span className="chip ok">✓ Revenue attribution active</span>
                <span className="chip">⟳ Campaign data synchronized</span>
              </div>
            </div>
            <div className="dash-ai">
              <span className="dash-ai-tag">✦ Next recommended action</span>
              <strong>Review campaign opportunities</strong>
              <p>
                See which campaigns should be scaled, improved, or paused based on actual business
                results.
              </p>
              <span className="dash-ai-btn">View Recommendations →</span>
            </div>
          </section>
              ...
              <div className="dash-kpi" key={m.k}>
                ...
                <svg className="dash-kpi-spark" viewBox="0 0 100 32" preserveAspectRatio="none">
                  <path
                    d={sparks[m.spark]}
                    fill="none"
                    stroke={m.spark === "down" ? "#F5A623" : "#16F2E3"}
                    strokeWidth="2"
                    strokeLinecap="round"
                    strokeLinejoin="round"
            ...
            <div className="dash-panel dash-panel-main">
              ...
              <svg className="dash-bigchart" viewBox="0 0 760 240" preserveAspectRatio="none">
                ...
                <path
                  ...
                  strokeLinecap="round"
                  vectorEffect="non-scaling-stroke"
                  className="dash-line dash-line-spend"
                />
                <path
                  d={REV}
                  fill="none"
                  ...
                  strokeLinejoin="round"
                  vectorEffect="non-scaling-stroke"
                  className="dash-line dash-line-rev"
                />
              </svg>
            ...
            <div className="dash-side-col">
              <div className="dash-panel">
                ...
                <svg className="dash-roas" viewBox="0 0 220 70" preserveAspectRatio="none">
                  <path
                    d="M6,40 L40,38 L74,41 L108,37 L142,39 L176,36 L214,38"
                    fill="none"
                    stroke="#5B8DEF"
                    strokeWidth="2"
                    strokeLinecap="round"
                    vectorEffect="non-scaling-stroke"
                    className="dash-line dash-line-roas"
                  />
                </svg>
              </div>
              <div className="dash-panel">
                ...
                <div className="dash-bars">
                  {Array.from({ length: 30 }).map((_, i) => (
                    <i
                      key={i}
                      style={{ height: `${22 + Math.round((i / 29) * 70 + (i % 3) * 4)}%` }}
                    />
                  ))}
                </div>
              </div>
